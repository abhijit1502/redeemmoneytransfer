                                        ...
                                        <div className="form-card">
                                                ...
                                                <div className="col-12 col-md-4 col-lg-4">
                                                    <div className="card cardcss">
                                                        ...
                                                        <div className="card-body">
                                                            <p className="card-text m-0">On completion of your IDScan
                                                                and Liveness check you will get a success screen to
                                                                confirm completion of onboarding.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="row justify-content-center">
                                                <div className="col-12 text-center">
                                                    <h6 className="purple-text text-center mt-3 mb-4">If you have any
                                                        further questions then please visit our Onboarding FAQs page.
                                                    </h6>
                                                </div>
                                                <div className='col-xl-6 col-lg-6 col-12'>
                                                    <NavLink to="/onboarding-faq" className="theme-btn style-one">
                                                        FAQs</NavLink>
                                                </div>
                                            </div>
                                        </div>
